...
Add_Sub_Opcode :: enum {
	UNDEFINED,
	REGMEM_WITH_REG_TO_EITHER,
	IMMEDIATE_TO_ACCUMULATOR,
	IMMEDIATE_TO_REGMEM,
}

add_sub_op_code_checks :: proc(s1: string, dtc: ^Transfer_Code) {
...
_add_sub_bit_string_to_opt :: proc(s: string) -> Add_Sub_Opcode {
	switch {
	case strings.has_prefix(s, "0000010"), strings.has_prefix(s, "0010110"):
		return .IMMEDIATE_TO_ACCUMULATOR
	case strings.has_prefix(s, "100000"):
		return .IMMEDIATE_TO_REGMEM
	case strings.has_prefix(s, "000000"), strings.has_prefix(s, "001010"):
		return .REGMEM_WITH_REG_TO_EITHER
	}
...
decode_add_sub :: proc(
	...
	switch _add_sub_bit_string_to_opt(s1) {
	case .REGMEM_WITH_REG_TO_EITHER:
